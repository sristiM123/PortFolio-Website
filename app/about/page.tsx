...
export default function AboutPage() {
    // Update these links to official university sites
    const education = [
        {
            school: 'Ss. Cyril and Methodius University in Skopje (FINKI,UKIM)',
            schoolUrl: 'https://www.ukim.edu.mk/', // Ss. Cyril and Methodius University in Skopje
            degree: 'MSc in Applied Cyber Security',
            tag: 'Masters',
            period: '2025 — Present',
            points: [
                'Research: Thesis Topic (On progress), Optimization of large prime numbers using ML',
                'Coursework: Web and Mobile Application Security, Multimedia and Scalable Web, Cryptography, Digital Trust and privacy',
            ],
            cgpa: '—',
        },
        {
            ...
            period: '2024 — 2025',
            points: [
                'Research: Reputation and Energy aware Dynamic Hybrid Consensus (READ-HC) Model for IIoT',
    ...
    // Scholarship‑focused honors (edit copy freely to reflect specifics)
    const scholarships = [
        {
        ...
        },
        {
            ...
            org: 'Delhi Technological Univeristy',
            year: '2019-2023',
            blurb:
                'The ICCR (Indian Council for Cultural Relations) Scholarship is a highly prestigious program that fosters global academic excellence and cross-cultural exchange by supporting outstanding international students in leading universities across India.',
        },
    ]
            ...
            <section className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8 pt-14 pb-6">
                ...
                >
                    ...
                    <motion.p variants={fadeUp} className="max-w-3xl text-base sm:text-lg text-neutral-800 leading-relaxed">
                        Hi, I’m <span className="font-semibold text-orange-800">Sristi Mitra</span> I’m a Master’s student in Cyber Security with hands-on SOC experience, <span className="font-medium text-amber-800">CCNA certification, and active research in IoT security </span>. I aim to contribute as a Security Engineer building resilient, privacy-focused systems.
                         AI, privacy, and security — from phishing detection to
                        cryptography research. If it helps secure the digital world, I’m in.
                    </motion.p>
                ...
                <div className="relative pl-6 sm:pl-10">
                    ...
                    <div className="space-y-6">
                        {education.map((item, idx) => (
                            <motion.div key={idx} variants={stagger} initial="hidden" whileInView="show" viewport={{ once: true }}>
                                <div className="absolute -left-1 top-6 h-4 w-4 rounded-full bg-amber-500 ring-4 ring-white" />
                                <Card>
                                    <div className="flex items-start justify-between gap-4 p-6">
                                        ...
                                        <div className="text-sm sm:text-base text-orange-700">{item.period}</div>
                                    </div>
                                </Card>
                            </motion.div>
                        ))}
                        ...
                        <Card key={i} className="p-5">
                            <motion.div variants={fadeUp}>
                                <div className="flex items-center justify-between">
                                    ...
                                    <span className="text-xs sm:text-sm text-orange-700">{s.year}</span>
                                </div>
