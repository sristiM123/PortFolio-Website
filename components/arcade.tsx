...
/** Home Arcade — open games on their own pages */
...
function ArcadeCard({
    ...
    return (
        <Link
            href={href}
            className="block rounded-2xl border border-amber-100 bg-white/90 p-5 text-left shadow-sm transition hover:shadow-md focus:outline-none focus:ring-2 focus:ring-amber-300"
        >
            ...
            <span className="mt-4 inline-block rounded-xl bg-orange-900 px-4 py-2 text-white">
        Open ↗
      </span>
        </Link>
    );
